# 📘 GET-методы — Визиты, Склады, Остатки (9.21–9.25)
...
**Описание:** Получение данных о визитах агентов к клиентам. Включает информацию о плановых и фактических визитах, GPS-статус, наличие заказов и фотоотчётов.
...
**Описание:** Получение списка складов (тип: обычный склад).
...
**Описание:** Получение списка складов для возврата (дефектных товаров).
...
**Описание:** Получение текущих складских остатков, сгруппированных по складам.
...
**Описание:** Получение складских остатков на указанную дату. Рассчитывается на основе журнала складских операций.
...
[← Назад к оглавлению](README.md) | [Далее: Заказы →](04-get-orders.md)
